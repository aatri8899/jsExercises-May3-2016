...
/*
  ...
  ie:
    ...
    gradeScore(80) -> "C"
*/
function gradeScore(result){
  if (result > 90){
    return ("A");
  }
  else if (result < 91 && result>=81){
  return ("B");
  }
  else {
    return ("C");
...
*/
function imDone (name, grade, school){
  if (name && grade){
    return ("yes");
  }
  if (grade && school){
